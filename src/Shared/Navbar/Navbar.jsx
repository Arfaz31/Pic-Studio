...
const Navbar = () => {
  ...
  const handleLogOut = () =>{
   ...
   {user? <> 
    ...
    <div className="md:mr-4 md:ml-4 mr-0 ml-3 md:mt-0 mt-2">
            <a
   ...
   <> 
    ...
    return (
        <div className="navbar bg-cyan-200 bg-opacity-30 text-black fixed z-10 ">
  ...
  {/* this hidden checkbox controls the navbar color state */}
