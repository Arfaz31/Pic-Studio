    ...
    return (
        <div className='my-28'>
            <div className='flex justify-center items-center'>
                <h2 className='font-bold text-4xl text-black pr-3'>ACHIEVEMENTS</h2>
                <img src={logo} alt="" />
            </div>
            <p className='text-center text-base mt-4 mb-12'>"Photography is an art of observation. It's about finding something interesting in an ordinary place." </p>
            

            <div className='grid md:grid-cols-3 grid-cols-1 gap-10 md:gap-0'>
